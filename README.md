...
`OperacaoInvalida` representa um código diferente de M e S. `EntradaInvalida` representa números não inteiros, quantidade incorreta de argumentos, zero ou números negativos no MDC e números negativos na soma dos dígitos. Ambas herdam de `Exception`.
